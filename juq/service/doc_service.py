...
from .utils import filter_empty_params, change_doc_toc, dump_toc, toc_line_repr
...
def toc(repo_id: str, id_: str, before: str, after: str, depth: int, **_):
...
def create(repo_id: str, file: str, slug: str, title: str, public: int, **_):
    ...
    return doc_handler.create_doc(**params)
